...
const Single = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.put(`/api/${entityType}/67a9ef35d958e0df94afa018`, {
        ...formData,
    ...
    <div className="single">
      ...
      <div className="singleContainer">
        ...
        <div className="top">
          ...
          <div className="right">
            <Chart aspect={3 / 1} title={`${entityType.charAt(0).toUpperCase() + entityType.slice(1)} Statistics`} />
          </div>
        </div>
